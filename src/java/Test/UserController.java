    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (op != null && op.equals("varify")) {
            ...
            if(ud.isUseridExist(userid))
                out.println("<font color='blue' size='4' face= 'corbel'> Sorry! this userid exists</font>");
            else
                out.println("<font color='blue' size='4' face= 'corbel'> This userid is available</font>");
        } 
            ...
            if(ud.isContactExist(contact))
                out.println("<font color='blue' size='4' face= 'corbel'> Sorry! this userid exists</font>");
           // else
             //   out.println("<font color='blue' size='4' face= 'corbel'> This contact is available</font>");
        } 
