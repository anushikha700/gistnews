<%-- 
    Document   : reg1
    Created on : Mar 2, 2020, 7:29:36 PM
    Author     : anushikha
--%>
...
<html>
    <head>
        ...
        function validateRegistrationForm(form) {
            let result = checkAge(form.dob.value);
            result = result && comparePwds(form.password.value, form.rpassword.value);
            return result;
        }
...
background:#2d2d2d;}
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col col-md-10">
                    ...
                    <form action="reg2.jsp" method="post" class="form" name="regForm" onsubmit="return validateRegistrationForm(regForm);">
 ...
 <tr>
            ...
            <tr>
                ...
                <td><input type="email" required="required"  value="${user.userid}"name="userid" class="form-control" onblur="varifyUserid(this.value,s1);"/>
                    <br/>
                    <span id="s1"> </span>
           ...
           <tr>
                ...
                <td><input type="password" name="password" value="${user.password}" id="password" class="form-control" pattern="(?=^.{3,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$"/><br/>
...
<tr>
            ...
            <tr>
                ...
                <th>
   <input type="submit" name="submit" value="Save and Next "  class="form-control btn btn-primary" disabled="disabled" id="submit"/>
