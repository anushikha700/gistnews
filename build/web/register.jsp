<%-- 
    Document   : register
    Created on : Feb 19, 2020, 7:21:59 AM
    Author     : anushikha
--%>
...
background:#2d2d2d;}
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col col-md-10">
                    ...
                    <form enctype="multipart/form-data" action="UserController?op=add" method="post" class="form" name="regForm" onsubmit="return validateRegistrationForm(regForm);">
 ...
 <tr>
            ...
            <tr>
                ...
                <td><input type="email" required="required" name="userid" class="form-control" onblur="varifyUserid(this.value,s1);"/>
<br/>
                    <span id="s1"> </span>
